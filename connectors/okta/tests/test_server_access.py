...
class TestAssetServer(unittest.TestCase):
    ...
    @patch('connector.server_access.AssetServer.get_collection')
    def test_get_application(self, mock_network):
        ...
        mock_network_res = OktaMockResponse(200, mock_api_return_value)
    ...
    @patch('connector.server_access.AssetServer.get_collection')
    def test_get_application_user(self, mock_network):
        """Unit test for get_vulnerabilities."""
    ...
    @patch('connector.server_access.AssetServer.get_collection')
    def test_get_application_user_error(self, mock_vul):
        """Unit test for get_vulnerabilities."""
        ...
        mock_vul_res = OktaMockResponse(400, b'Bad Request')
